-- Database: project-base-wahyu

-- DROP DATABASE IF EXISTS "project-base-wahyu";

CREATE DATABASE "project-base-wahyu"
    WITH
    OWNER = postgres
    ENCODING = 'UTF8'
    LC_COLLATE = 'Indonesian_Indonesia.utf8'
    LC_CTYPE = 'Indonesian_Indonesia.utf8'
